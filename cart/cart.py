...
class Cart:
    ...
    def add(self, product, quantity=1, override_quntity=False):
        """Добавить товар в корзину, либо обноить его количество."""
    ...
    def __iter__(self):
        ...
        # Получить объекты product и добвить их в корзину
